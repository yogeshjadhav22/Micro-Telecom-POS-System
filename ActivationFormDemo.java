...
class ActivationForms implements ActionListener,ItemListener,KeyListener
{
	 		...
	 		if(flag==true)
	 		{
	 			try
	 			{
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/micropos","root","");
	 				String qry="insert into Activation values(?,?,?,?,?,?,?,?,?,?)";
	 				...
	 				t6.setText("");
//	 				t7.setText("");
					cb2.setSelectedItem("34");
					cb1.setSelectedItem("Adhar Card");
					cb3.setVisible(false);
