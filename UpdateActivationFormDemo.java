...
class UpdateActivationForm implements ActionListener,ItemListener,KeyListener
{
	
	JButton b1,b2,b3;
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l,li,lr,erno1,erno2,erno3,erno4,erno5,erno6;
	JFrame f;
	JTextField t1,t2,t3,t4,t5,t6;
	Font f1,f2,f3,f4,f5;
	JComboBox cb1,cb2,cb3;
	JRadioButton r1,r2;
	String gen,poi,pa="-",no;
	int frc;
	ButtonGroup brg;
	
	 public UpdateActivationForm(String cnm,String number,String gender,String address,String newno,String proofi,String proofno,String first,String proofa,String dt)
	 {
	...
	/*	DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
		...
		f.setVisible(true);	
			...
			t1.setText(dt);
	 		...
	 		cb1.setSelectedItem(proofi);
	 		cb2.setSelectedItem(first);
	 		cb3.setSelectedItem(proofa);
	 ...
	 {
	 	 String mno,name,newno,date,adr,poino;
	 	 Boolean flag=true;
	 	...
	 	//	JOptionPane.showMessageDialog(null,mno,"Logged",JOptionPane.PLAIN_MESSAGE);
	 		...
	 		if(flag==true)
	 		{
	 			try
	 			{
	 				...
	 				String qry="update Activtion set Cname=?, Cno=?, Cgnder=?, Caddress=?,Newno=?, Poi=?,Poino=?, Frc=?,Pa=?, Date=? where Newno=?";
...
class UpdateActivationFormDemo
{
	public static void main(String arg[])
	{
		String cs=null,fg=null,ht=null,fd=null,gf=null,re=null,tg=null,sw=null;
		new UpdateActivationForm(cs,fg,ht,fd,gf,re,tg,fd,re,sw);
	}
}